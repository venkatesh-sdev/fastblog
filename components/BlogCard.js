...
const BlogCard = ({ post }) => {
  ...
  return (
    <React.Fragment>
      <Link
        href="/"
        className="flex flex-col items-center bg-skin-bgColor  border rounded-lg shadow-md md:flex-row md:max-w-xl transition-all duration-500 hover:bg-gradient-to-tr hover:shadow-gray-600  hover:bg-opacity-80 hover:box-shadow-2xl p-2 "
      >
        <img
